...
public class move_to_element_using_01_kalyan_jwellers {
	...
	public static void main(String[] args) {
		...
		WebElement jwl = driver.findElement(By.xpath("//a[.='Ambassadors']"));
		
		Actions act = new Actions(driver);
		act.moveToElement(jwl).perform();
		
		driver.findElement(By.xpath("//a[.='Amitabh Bachchan']")).click();
	}
