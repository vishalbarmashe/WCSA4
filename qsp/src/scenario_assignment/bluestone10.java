...
public class bluestone10 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		for(WebElement p:Price)
		{
			...
			System.out.println("Before apply 20GM filter price is   :  "+first);
		}
		...
		driver.findElement(By.xpath("//span[.='20 Gram']")).click();
		Thread.sleep(2000);
		...
		{
			String first = p.getText();
			System.out.println("after apply 20GM filter price is   :  "+first);
		}
